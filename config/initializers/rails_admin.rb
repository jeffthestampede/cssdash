# RailsAdmin config file. Generated on May 11, 2013 12:04
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Cssdash', 'Admin']
  ...
  # config.excluded_models = ['Comment', 'Content', 'Favorite', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Comment', 'Content', 'Favorite', 'User']
  ...
  #     configure :created_on, :date
  #     configure :created_at, :datetime
  #     configure :updated_at, :datetime
  #     configure :likes, :integer
  #     configure :views, :integer
  #     configure :favorites, :integer
  ...
  #     configure :id, :integer
  #     configure :user_id, :integer         # Hidden
  #     configure :content_id, :integer
  #     configure :deleted, :boolean
  #     configure :shared_on_fb, :boolean
  #     configure :shared_on_twitter, :boolean
  #     configure :created_at, :datetime
  #     configure :updated_at, :datetime
  ...
  #     configure :profile_img_url, :string
  #     configure :first_name, :string
  #     configure :last_name, :string
  #     configure :bio, :text
  #     configure :twitter_link, :string
  #     configure :github_link, :string
  #     configure :dribbble_link, :string
